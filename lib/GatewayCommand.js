class GatewayCommand {
    ...
    /**
     *
     * @param waitForExtraReponse - if the adapter needs to wait for more messages after the MethodReponse from the gateway before sending more messages
     * @param identifier - when a device command is sent this is used to identify the correct GatewayCommand for a response or event
     */
